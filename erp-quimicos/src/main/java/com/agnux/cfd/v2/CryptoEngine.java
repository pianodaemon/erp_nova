...
/*********************** INICIA - Codigo para la sign ********************************/
    ...
    *
    * @param pk
    *            The public key from The Cert used.
    * @param cadenaoriginal
    *            The Origina String unsigned.
    * @param hash_md5_firmado
    *            The Md5 Signed on Array byte format.
    *
    ...
    *
    * @param certfile
    *            The file with a Path where private key is found.
    *
    ...
    *            The file with a Path where private key is found.
    * @param password
    *            The password of The Prtivate key.
    * @param cadenaoriginal
