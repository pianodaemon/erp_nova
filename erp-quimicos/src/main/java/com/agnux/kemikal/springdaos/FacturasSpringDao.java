    ...
    public HashMap<String, String> getDataFacturaXml(Integer id_prefactura) {
        ...
        String sql_to_query = ""
                + "SELECT erp_prefacturas.cliente_id, "
                        ...
                        + "(CASE WHEN erp_prefacturas.cxc_clie_df_id > 1 THEN sbtdf.numero_interior ELSE (CASE WHEN cxc_clie.numero='' OR cxc_clie.numero IS NULL THEN cxc_clie.numero_exterior ELSE cxc_clie.numero END)  END ) AS numero_interior,"
