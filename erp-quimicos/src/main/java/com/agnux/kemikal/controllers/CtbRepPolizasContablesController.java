...
import com.agnux.kemikal.reportes.CtbPdfReportePolizasContables;
...
@RequestMapping("/ctbreppolizacont/")
public class CtbRepPolizasContablesController {
     ResourceProject resource = new ResourceProject();
    private static final Logger log  = Logger.getLogger(CtbRepPolizasContablesController.class.getName());
    ...
    public ModelAndView startUp(HttpServletRequest request, HttpServletResponse response, 
        ...
        log.log(Level.INFO, "Ejecutando starUp de {0}", CtbRepPolizasContablesController.class.getName());
        LinkedHashMap<String,String> infoConstruccionTabla = new LinkedHashMap<String,String>();
        ModelAndView x = new ModelAndView("ctbreppolizacont/startup", "title", "Reporte de P&oacute;lizas Contables");
   ...
   @RequestMapping(method = RequestMethod.POST, value="/getDatos.json")
        ...
        jsonretorno.put("Anios", this.getCtbDao().getCtbRepPolizasCont_Anios());
        jsonretorno.put("Dato", arrayExtra);
        //Aqui solo nos interesa las subcuentas del nivel uno, por lo tanto le pasamos el numero 1
        jsonretorno.put("Cta", this.getCtbDao().getCtbRepPolizasCont_Ctas(1,"","", "", "", id_empresa));
   ...
   @RequestMapping(method = RequestMethod.POST, value="/getCtas.json")
    public @ResponseBody HashMap<String,ArrayList<HashMap<String, Object>>> getCtasJson(
        ...
        */
        ...
        ctas = this.getCtbDao().getCtbRepPolizasCont_Ctas(nivel, cta, scta, sscta, ssscta, id_empresa);
    ...
    public @ResponseBody HashMap<String,ArrayList<HashMap<String, String>>> getDatosReporteJson(
        ...
        log.log(Level.INFO, "Ejecutando getDatosReporteJson de {0}", CtbRepPolizasContablesController.class.getName());
        ...
        datos = this.getCtbDao().getCtbRepPolizasCont_Datos(data_string);
    ...
    @RequestMapping(value = "/getPdfPolizasCont/{cadena}/{iu}/out.json", method = RequestMethod.GET )
    public ModelAndView getGeneraPdfRepPolizasContJson(
        ...
        System.out.println("Generando Reporte de P&oacute;lizas Contables");
        ...
        datosEncabezadoPie.put("titulo_reporte", "Reporte de Pólizas Contables");
        ...
        String file_name = "RepPolizasCont_"+nombreMes+".pdf";
        ...
        CtbPdfReportePolizasContables x = new CtbPdfReportePolizasContables(fileout, datosEncabezadoPie, datosEmpresaEmisora, datos);
