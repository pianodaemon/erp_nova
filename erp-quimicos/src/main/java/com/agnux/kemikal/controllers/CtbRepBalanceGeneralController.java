...
@RequestMapping("/ctbrepbalancegnl/")
public class CtbRepBalanceGeneralController {
    ResourceProject resource = new ResourceProject();
    private static final Logger log  = Logger.getLogger(CtbRepBalanceGeneralController.class.getName());
    ...
    public ModelAndView startUp(HttpServletRequest request, HttpServletResponse response, 
        ...
        log.log(Level.INFO, "Ejecutando starUp de {0}", CtbRepBalanceGeneralController.class.getName());
        LinkedHashMap<String,String> infoConstruccionTabla = new LinkedHashMap<String,String>();
        ModelAndView x = new ModelAndView("ctbrepbalancegnl/startup", "title", "Reporte de Balance General");
   ...
   @RequestMapping(method = RequestMethod.POST, value="/getDatos.json")
        ...
        jsonretorno.put("Anios", this.getCtbDao().getCtbRepBalanceGral_Anios());
        jsonretorno.put("Dato", arrayExtra);
        //Aqui solo nos interesa las subcuentas del nivel uno, por lo tanto le pasamos el numero 1
        jsonretorno.put("Cta", this.getCtbDao().getCtbRepBalanceGral_Ctas(1,"","", "", "", id_empresa));
   ...
   @RequestMapping(method = RequestMethod.POST, value="/getCtas.json")
    public @ResponseBody HashMap<String,ArrayList<HashMap<String, Object>>> getCtasJson(
        ...
        */
        ...
        ctas = this.getCtbDao().getCtbRepBalanceGral_Ctas(nivel, cta, scta, sscta, ssscta, id_empresa);
    ...
    public @ResponseBody HashMap<String,ArrayList<HashMap<String, String>>> getDatosReporteJson(
        ...
        log.log(Level.INFO, "Ejecutando getDatosReporteJson de {0}", CtbRepBalanceGeneralController.class.getName());
    ...
    public ModelAndView getGeneraPdfRepBalanceGeneralJson(
        ...
        String file_name = "RepBalanceGeneral_"+nombreMes+".pdf";
