...
import com.agnux.kemikal.reportes.PdfEstadisticoVentasAnualesXProducto;
...
@RequestMapping("/repestadisticaanualventasproducto/")
public class RepEstadisticasAnualesVentasProductoController {
    private static final Logger log  = Logger.getLogger(RepEstadisticasAnualesVentasProductoController.class.getName());
    ...
    public ModelAndView startUp(HttpServletRequest request, HttpServletResponse response, 
        ...
        log.log(Level.INFO, "Ejecutando starUp de {0}", RepEstadisticasAnualesVentasProductoController.class.getName());
        LinkedHashMap<String,String> infoConstruccionTabla = new LinkedHashMap<String,String>();
        
        
        ModelAndView x = new ModelAndView("repestadisticaanualventasproducto/startup", "title", "EstadisticasAnualVentasProducto");
   ...
   @RequestMapping(method = RequestMethod.POST, value="/getSubFamilias.json")
    ...
    public  @ResponseBody HashMap<String,ArrayList<HashMap<String, String>>> RepEstadisticasAnualesVentasProductoControllerJson(
        ...
        log.log(Level.INFO, "Ejecutando getEstadisticaVentasProducto de {0}", RepEstadisticasAnualesVentasProductoController.class.getName());
        HashMap<String,ArrayList<HashMap<String, String>>> jsonretorno = new HashMap<String,ArrayList<HashMap<String, String>>>();
...
//Genera pdf de facturacion de
    ...
    public ModelAndView getMakePDFJson(
        ...
        String file_name = "RepEstAnualProducto"+mesInicial+"_"+mesFinal+".pdf";
