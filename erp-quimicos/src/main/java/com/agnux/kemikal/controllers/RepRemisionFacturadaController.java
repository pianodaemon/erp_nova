...
import com.agnux.kemikal.reportes.PdfReporteRemisionFacturada;
...
@RequestMapping("/repremisionfacturada/")
public class RepRemisionFacturadaController {
    private static final Logger log  = Logger.getLogger(RepRemisionFacturadaController.class.getName());
    ...
    public ModelAndView startUp(HttpServletRequest request, HttpServletResponse response, 
        ...
        log.log(Level.INFO, "Ejecutando starUp de {0}", RepRemisionFacturadaController.class.getName());
        LinkedHashMap<String,String> infoConstruccionTabla = new LinkedHashMap<String,String>();
        
        
        ModelAndView x = new ModelAndView("repremisionfacturada/startup", "title", "Remisiones facturadas");
    ...
    @RequestMapping(method = RequestMethod.POST, value="/getRemision_Facturada.json")
    public @ResponseBody HashMap<String,ArrayList<HashMap<String, String>>> getRemision_FacturadaJson(
            @RequestParam("opcion") Integer opcion,
            @RequestParam("remision_facturada") String remision_facturada,
        ...
        log.log(Level.INFO, "Ejecutando getRemision_Facturada de {0}", RepRemisionFacturadaController.class.getName());
        ...
        remision_facturada = "%"+remision_facturada+"%";
        cliente = "%"+cliente+"%";
        ...
        remisiones = this.getFacdao().getDatosReporteRemision_facturada(opcion, remision_facturada, cliente, fecha_inicial, fecha_final, id_empresa);
    ...
    @RequestMapping(value = "/get_genera_reporte_remision_facturada/{cadena}/{iu}/out.json", method = RequestMethod.GET ) 
    public ModelAndView getGeneraPdfRemisionJson(
        ...
        String file_name = "REP_REM_FACT_"+rfc+"_"+fecha_inicial+"_"+fecha_final+".pdf";
        
        //ruta de archivo de salida
        String fileout = file_dir_tmp +"/"+  file_name;
        
        //RUTA DE SALIDA EN  s.o WINDOWS
        //String fileout ="C:\\Users\\micompu\\Desktop\\REP_REMFACTURADAS"+rfc+"_"+fecha_inicial+"_"+fecha_final+".pdf";
        
        //obtiene las remisiones del periodo indicado
        lista_remisiones = this.getFacdao().getDatosReporteRemision_facturada(opciones, remision_facturada, cliente, fecha_inicial, fecha_final, id_empresa);
        
        //instancia a la clase que construye el pdf del reporte de facturas
        PdfReporteRemisionFacturada x = new PdfReporteRemisionFacturada( fileout,ruta_imagen,razon_social_empresa,fecha_inicial,fecha_final,lista_remisiones);
