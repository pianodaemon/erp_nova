...
public class RepVentasNetasProductoFacturaController {
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, String>>> get_cargando_filtrosJson(
    ...
    public ModelAndView PdfVentasNetasProductoFactura(
        ...
        //cadena = tipo_reporte+"___"+cliente+"___"+producto+"___"+fecha_inicial+"___"+fecha_final+"___"+usuario+"___"+id_linea+"___"+id_marca+"___"+id_familia+"___"+id_subfamilia+"___"+tipo_costo+"___" id_agente
        ...
        if (Integer.parseInt(arreglo[0]) == 1) {
            ...
            PdfRepVentasNetasProductoFactura x = new PdfRepVentasNetasProductoFactura(Integer.parseInt(arreglo[0]), arraysumatorias, lista_ventasporproducto, arreglo[3], arreglo[4], razon_social_empresa, fileout);
        }

        if (Integer.parseInt(arreglo[0]) == 4) {
            //instancia a la clase que construye el pdf ventas netas Sumarizado por Cliente
            PdfReporteVentasNetasSumatoriaxClientes x = new PdfReporteVentasNetasSumatoriaxClientes(Integer.parseInt(arreglo[0]), arraysumatorias,lista_ventasporproducto, arreglo[2], arreglo[3], arreglo[4], razon_social_empresa, fileout);
        }

        if (Integer.parseInt(arreglo[0]) == 2) {
            //instancia a la clase que construye el pdf ventas netas por Producto
            PdfReporteVentasNetasProductoFacturados x = new PdfReporteVentasNetasProductoFacturados(Integer.parseInt(arreglo[0]), arraysumatorias,lista_ventasporproducto, arreglo[3], arreglo[4], razon_social_empresa, fileout);
        }
        if (Integer.parseInt(arreglo[0]) == 3) {
            //instancia a la clase que construye el pdf ventas netas Sumarizado por Producto
            PdfReporteVentasNetasSumatoriaxProducto x = new PdfReporteVentasNetasSumatoriaxProducto(Integer.parseInt(arreglo[0]), arraysumatorias,lista_ventasporproducto, arreglo[1], arreglo[3], arreglo[4], razon_social_empresa, fileout);
        }
