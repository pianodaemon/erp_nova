...
import com.agnux.kemikal.reportes.CxcIepsCobradoPorClientePdf;
import com.agnux.kemikal.reportes.CxcIepsCobradoPorClienteXls;
...
@RequestMapping("/cxcrepiepsxcliente/")
public class CxcRepIepsPorClienteController {
    private static final Logger log  = Logger.getLogger(CxcRepIepsPorClienteController.class.getName());
    ...
    public ModelAndView startUp(HttpServletRequest request, HttpServletResponse response, 
        ...
        log.log(Level.INFO, "Ejecutando starUp de {0}", CxcRepIepsPorClienteController.class.getName());
        LinkedHashMap<String,String> infoConstruccionTabla = new LinkedHashMap<String,String>();
        
        ModelAndView x = new ModelAndView("cxcrepiepsxcliente/startup", "title", "Reporte de IEPS Cobrado por Cliente");
    ...
    public @ResponseBody HashMap<String,Object> getDatosReporteJson(
        ...
        log.log(Level.INFO, "Ejecutando getDatosIEPSCobradoPorClienteJson de {0}", CxcRepIepsPorClienteController.class.getName());
        ...
        String keyIndex="cliente";
        columnsHead.put(keyIndex, "CLIENTE:350:left");
        columnsBody.put(keyIndex, "350:left");
        widthMainTable += 350;
        noCols++;
        ...
        datos = this.getCxcDao().getDatosCxcReporteIepsCobradoPorCliente(listaIeps, ciente, finicial, ffinal, id_empresa);
    ...
    public ModelAndView getPdfJson(
        ...
        String tituloReporte="IEPS Cobrado por Cliente";
        ...
        //String tipo_fichero = ArrayCad[3];
        ...
        String file_name = "CxcIepsCobradoPorCliente_"+fecha_corte+".pdf";
        ...
        //Obtener datos del Ieps cobrado
        datos = this.getCxcDao().getDatosCxcReporteIepsCobradoPorCliente(listaIeps, cliente, fechaInicial, fechaFinal, id_empresa);
        ...
        //columnsBody = Para mostrar los datos del reporte, incluye Ancho y Alineacion del texto en la celda
        String keyIndex="cliente";
        columnsHead.put(keyIndex, "CLIENTE:left");
        columnsBody.put(keyIndex, "350:left");
        widthMainTable += 350;
        noCols++;
        ...
        CxcIepsCobradoPorClientePdf x = new CxcIepsCobradoPorClientePdf(data);
    ...
    //Genera pdf de estados de cuenta
    @RequestMapping(value = "/getXls/{cadena}/{iu}/out.json", method = RequestMethod.GET ) 
    public ModelAndView getXlsJson(
                @PathVariable("cadena") String cadena,
                @PathVariable("iu") String id_user_cod,
                HttpServletRequest request, 
                HttpServletResponse response, 
        ...
        String file_name = "CxcIepsCobradoPorCliente_"+fecha_corte+".xls";
        ...
        //instancia a la clase que construye el pdf de la del reporte de estado de cuentas del cliente
        CxcIepsCobradoPorClienteXls x = new CxcIepsCobradoPorClienteXls(data);
