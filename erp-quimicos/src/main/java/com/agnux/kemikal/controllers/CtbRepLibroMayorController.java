...
import com.agnux.kemikal.reportes.CtbPdfReporteLibroMayor;
...
@RequestMapping("/ctbreplibromayor/")
public class CtbRepLibroMayorController {
    ResourceProject resource = new ResourceProject();
    private static final Logger log  = Logger.getLogger(CtbRepLibroMayorController.class.getName());
    ...
    public ModelAndView startUp(HttpServletRequest request, HttpServletResponse response, 
        ...
        log.log(Level.INFO, "Ejecutando starUp de {0}", CtbRepLibroMayorController.class.getName());
        LinkedHashMap<String,String> infoConstruccionTabla = new LinkedHashMap<String,String>();
        ModelAndView x = new ModelAndView("ctbreplibromayor/startup", "title", "Reporte de Libro Mayor");
   ...
   @RequestMapping(method = RequestMethod.POST, value="/getDatos.json")
        ...
        jsonretorno.put("Anios", this.getCtbDao().getCtbRepLibroMayor_Anios());
        jsonretorno.put("Dato", arrayExtra);
        //Aqui solo nos interesa las subcuentas del nivel uno, por lo tanto le pasamos el numero 1
        jsonretorno.put("Cta", this.getCtbDao().getCtbRepLibroMayor_Ctas(1,"","", "", "", id_empresa));
   ...
   @RequestMapping(method = RequestMethod.POST, value="/getCtas.json")
    public @ResponseBody HashMap<String,ArrayList<HashMap<String, Object>>> getCtasJson(
        ...
        */
        ...
        ctas = this.getCtbDao().getCtbRepLibroMayor_Ctas(nivel, cta, scta, sscta, ssscta, id_empresa);
    ...
    public @ResponseBody HashMap<String,ArrayList<HashMap<String, String>>> getDatosReporteJson(
        ...
        datos = this.getCtbDao().getCtbRepLibroMayor_Datos(data_string);
    ...
    @RequestMapping(value = "/getPdfLibroMayor/{cadena}/{iu}/out.json", method = RequestMethod.GET )
    public ModelAndView getGeneraPdfRepLibroMayorJson(
        ...
        System.out.println("Generando Reporte de Libro Mayor");
        ...
        datosEncabezadoPie.put("titulo_reporte", "Libro Mayor");
        ...
        String file_name = "RepLibroMayor_"+nombreMes+".pdf";
        ...
        CtbPdfReporteLibroMayor x = new CtbPdfReporteLibroMayor(fileout, datosEncabezadoPie, datosEmpresaEmisora, datos);
