...
@RequestMapping("/cxpevaluacionprov/")
public class CxpEvaluacionProvController {
    private static final Logger log  = Logger.getLogger(CxpEvaluacionProvController.class.getName());
    ...
    public ModelAndView startUp(HttpServletRequest request, HttpServletResponse response, 
        ...
        log.log(Level.INFO, "Ejecutando starUp de {0}", CxpEvaluacionProvController.class.getName());
        LinkedHashMap<String,String> infoConstruccionTabla = new LinkedHashMap<String,String>();
        
        ModelAndView x = new ModelAndView("cxpevaluacionprov/startup", "title", "Evaluaci&oacute;n de Proveedores");
   ...
   @RequestMapping(method = RequestMethod.POST, value="/getDatos.json")
    ...
    public @ResponseBody HashMap<String,ArrayList<HashMap<String, String>>> getReporteSaldosJson(
        ...
        log.log(Level.INFO, "Ejecutando getReporteSaldosJson de {0}", CxpEvaluacionProvController.class.getName());
        HashMap<String,ArrayList<HashMap<String, String>>> jsonretorno = new HashMap<String,ArrayList<HashMap<String, String>>>();
