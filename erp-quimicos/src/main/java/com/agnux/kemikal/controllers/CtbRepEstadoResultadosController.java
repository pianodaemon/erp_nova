...
import com.agnux.kemikal.reportes.CtbPdfReporteEstadoDeResultados;
...
public class CtbRepEstadoResultadosController {
   ...
   @RequestMapping(method = RequestMethod.POST, value="/getDatos.json")
        ...
        jsonretorno.put("Anios", this.getCtbDao().getCtbRepEstadoResult_Anios());
        jsonretorno.put("Dato", arrayExtra);
        //Aqui solo nos interesa las subcuentas del nivel uno, por lo tanto le pasamos el numero 1
        jsonretorno.put("Cta", this.getCtbDao().getCtbRepEstadoResult_Ctas(1,"","", "", "", id_empresa));
   ...
   @RequestMapping(method = RequestMethod.POST, value="/getCtas.json")
    public @ResponseBody HashMap<String,ArrayList<HashMap<String, Object>>> getCtasJson(
        ...
        */
        ...
        ctas = this.getCtbDao().getCtbRepEstadoResult_Ctas(nivel, cta, scta, sscta, ssscta, id_empresa);
    ...
    public @ResponseBody HashMap<String,ArrayList<HashMap<String, String>>> getDatosReporteJson(
        ...
        datos = this.getCtbDao().getCtbRepEstadoResult_Datos(data_string);
    ...
    @RequestMapping(value = "/getPdfRepEstadoResultados/{cadena}/{iu}/out.json", method = RequestMethod.GET )
    public ModelAndView getGeneraPdfRepEstadoResultados(
        ...
        System.out.println("Generando Reporte de Estado de Resultados");
        ...
        String file_name = "RepEdodResulados_"+nombreMes+".pdf";
        ...
        CtbPdfReporteEstadoDeResultados x = new CtbPdfReporteEstadoDeResultados(fileout, datosEncabezadoPie, datosEmpresaEmisora, datos);
