...
import com.agnux.kemikal.reportes.CtbPdfReporteEstadoDeResultadosAnual;
...
@RequestMapping("/ctbrepestadoresultanual/")
public class CtbRepEstadoResultadoAnualController {
    ...
    public ModelAndView startUp(HttpServletRequest request, HttpServletResponse response, 
        ...
        log.log(Level.INFO, "Ejecutando starUp de {0}", CtbRepEstadoResultadoAnualController.class.getName());
        LinkedHashMap<String,String> infoConstruccionTabla = new LinkedHashMap<String,String>();
        ModelAndView x = new ModelAndView("ctbrepestadoresultanual/startup", "title", "Reporte de Estado de Resultados Anual");
   ...
   @RequestMapping(method = RequestMethod.POST, value="/getDatos.json")
        ...
        jsonretorno.put("Anios", this.getCtbDao().getCtbRepEstadoResultAnual_Anios());
        jsonretorno.put("Dato", arrayExtra);
        //Aqui solo nos interesa las subcuentas del nivel uno, por lo tanto le pasamos el numero 1
        jsonretorno.put("Cta", this.getCtbDao().getCtbRepEstadoResultAnual_Ctas(1,"","", "", "", id_empresa));
   ...
   @RequestMapping(method = RequestMethod.POST, value="/getCtas.json")
    public @ResponseBody HashMap<String,ArrayList<HashMap<String, Object>>> getCtasJson(
        ...
        */
        ...
        ctas = this.getCtbDao().getCtbRepEstadoResultAnual_Ctas(nivel, cta, scta, sscta, ssscta, id_empresa);
    ...
    public @ResponseBody HashMap<String,ArrayList<HashMap<String, String>>> getDatosReporteJson(
        ...
        log.log(Level.INFO, "Ejecutando getDatosReporteJson de {0}", CtbRepEstadoResultadoAnualController.class.getName());
        ...
        datos = this.getCtbDao().getCtbRepEstadoResultAnual_Datos(data_string);
    ...
    @RequestMapping(value = "/getPdfRepEstadoResultadosAnual/{cadena}/{iu}/out.json", method = RequestMethod.GET )
    public ModelAndView getGeneraPdfRepEstadoResultadosAnualJson(
        ...
        System.out.println("Generando Reporte de Estado de Resultados Anual");
        ...
        datosEncabezadoPie.put("titulo_reporte", "Estado de Resultados Anual");
        ...
        String file_name = "RepEdodResuladosAnual_"+nombreMes+".pdf";
        ...
        CtbPdfReporteEstadoDeResultadosAnual x = new CtbPdfReporteEstadoDeResultadosAnual(fileout, datosEncabezadoPie, datosEmpresaEmisora, datos);
