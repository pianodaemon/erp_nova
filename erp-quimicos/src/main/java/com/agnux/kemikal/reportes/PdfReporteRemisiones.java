 ...
 * @author Vale Santos
 */
public class PdfReporteRemisiones {
        ...
        try {
            ...
            if(listaRemisiones.size() > 0){
                for (int x=0; x<=listaRemisiones.size()-1;x++){
                    ...
                    //columna fecha
                    cell= new PdfPCell(new Paragraph(registro.get("fecha_remision"),smallFont));
                    cell.setHorizontalAlignment (Element.ALIGN_CENTER);
                    cell.setBorder(0);
                    table.addCell(cell);
                    ...
                    //columna moneda
                    cell= new PdfPCell(new Paragraph(registro.get("moneda_remision"),smallFont));
                    cell.setHorizontalAlignment (Element.ALIGN_CENTER);
                    cell.setBorder(0);
                    table.addCell(cell);
    ...
    static class HeaderFooter extends PdfPageEventHelper {
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            ...
            ColumnText.showTextAligned(writer.getDirectContent(),Element.ALIGN_CENTER, new Phrase("Reporte de Remision",largeBoldFont),document.getPageSize().getWidth()/2, document.getPageSize().getTop()-38, 0);
