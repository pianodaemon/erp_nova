 ...
 * @author agnux
 */
public class CtbPdfReporteEstadoDeResultadosAnual {
    ...
    public CtbPdfReporteEstadoDeResultadosAnual(String fileout, HashMap<String, String> datosEncabezadoPie, HashMap<String, String> datosEmpresa, ArrayList<HashMap<String, String>> datos){
    ...
    private void init(){
       ...
       // float [] ancho_columnas = {1f, 1f, 1f, 1f, 1f, 1f, 2f, 1.5f, 1.5f, 1.5f, 1.5f};
        // float [] ancho_columnas = {1.5f, 1.5f, 1.5f, 1.5f, 1.5f, 1.5f};
         //float [] ancho_columnas = {1.5f, 1.5f, 1.5f, 1.5f, 1.5f};
         float [] ancho_columnas = {2f,1.5f,1.5f,1.5f,1.5f,1.5f,1.5f,1.5f,1.8f,1.5f,1.8f,1.5f,1.5f,2f};
       // float [] ancho_columnas = {1f, 1f,1f, 1f, 1f, 1f};
        ...
        try {
           ...
           String[] columnasHeader = {"Descripción","Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre","Total"};
            //String[] columnasHeader = {"Sucursal","Póliza","Orig","Tip Pol","Fecha","Cheque","C.C.","Descripción","Debe","Haber","Saldo"};
            ...
            for ( String columna_titulo : lista_columnas_header){
                ...
                if (columna_titulo.equals("Enero")){
                    cellX.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellX.setVerticalAlignment(Element.ALIGN_MIDDLE);   
                }

                if (columna_titulo.equals("Febrero")){
                    cellX.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellX.setVerticalAlignment(Element.ALIGN_MIDDLE);   
                }

                if (columna_titulo.equals("Marzo")){
                    cellX.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellX.setVerticalAlignment(Element.ALIGN_MIDDLE);   
                }
                
                 if (columna_titulo.equals("Abril")){
                    cellX.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellX.setVerticalAlignment(Element.ALIGN_MIDDLE);   
                }
                
                 if (columna_titulo.equals("Mayo")){
                    cellX.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellX.setVerticalAlignment(Element.ALIGN_MIDDLE);   
                }
              

                if (columna_titulo.equals("Junio")){
                    cellX.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellX.setVerticalAlignment(Element.ALIGN_MIDDLE);   
                }
                
                if (columna_titulo.equals("Julio")){
                    cellX.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellX.setVerticalAlignment(Element.ALIGN_MIDDLE);   
                }
                
                if (columna_titulo.equals("Agosto")){
                    cellX.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellX.setVerticalAlignment(Element.ALIGN_MIDDLE);   
                }
                
               if (columna_titulo.equals("Septiembre")){
                    cellX.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellX.setVerticalAlignment(Element.ALIGN_MIDDLE);   
                }

                if (columna_titulo.equals("Octubre")){
                    cellX.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellX.setVerticalAlignment(Element.ALIGN_MIDDLE);   
                }
                
                if (columna_titulo.equals("Noviembre")){
                    cellX.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellX.setVerticalAlignment(Element.ALIGN_MIDDLE);   
                }
                
                if (columna_titulo.equals("Diciembre")){
                    cellX.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellX.setVerticalAlignment(Element.ALIGN_MIDDLE);   
                }
            ...
            for (HashMap<String, String> i : this.getRows()){
                ...
                //String[] wordList = {"descripcion","saldo","saldo","saldo","saldo","saldo","saldo","saldo","saldo","saldo","saldo"};
                String[] wordList = {"descripcion","saldo_inicial","saldo_inicial","saldo_inicial","saldo_inicial","saldo_inicial","saldo_inicial","saldo_inicial","saldo_inicial","saldo_inicial","saldo_inicial","saldo_inicial","saldo_inicial","saldo_inicial"};
           ...
           /*
                ...
                cellX = new PdfPCell(new Paragraph(i.get(omega).get("suc").toString(),smallBoldFont));
