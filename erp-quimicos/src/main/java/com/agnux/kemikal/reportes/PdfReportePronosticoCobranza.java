...
public class PdfReportePronosticoCobranza {
    ...
    public PdfReportePronosticoCobranza(ArrayList<HashMap<String, String>> lista_pronostico, String razon_social_empresa, String fileout) {
    this.setEmpresa_emisora(razon_social_empresa);
        //this.setEmpresa_emisora(razon_social_empresa);
        PdfReportePronosticoCobranza.HeaderFooter event = new PdfReportePronosticoCobranza.HeaderFooter();
    ...
    class HeaderFooter extends PdfPageEventHelper  {
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            ...
            ColumnText.showTextAligned(writer.getDirectContent(),Element.ALIGN_CENTER, new Phrase(PdfReportePronosticoCobranza.this.getEmpresa_emisora(),largeBoldFont),document.getPageSize().getWidth()/2, document.getPageSize().getTop() -25, 0);
            ColumnText.showTextAligned(writer.getDirectContent(),Element.ALIGN_CENTER, new Phrase("Pronostico de Cobranza",largeBoldFont),document.getPageSize().getWidth()/2, document.getPageSize().getTop()-38, 0);
