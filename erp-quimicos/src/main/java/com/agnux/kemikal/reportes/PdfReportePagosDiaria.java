 ...
 * @author agnux
 */
public class PdfReportePagosDiaria {
        
          public PdfReportePagosDiaria(HashMap<String, String> datosEncabezadoPie, String fileout, ArrayList<HashMap<String, String>> lista_PagosDiaria, HashMap<String, String> datos) throws DocumentException {
               ...
               try {
                    ...
                    HeaderFooter event = new PdfReportePagosDiaria.HeaderFooter(datos);
