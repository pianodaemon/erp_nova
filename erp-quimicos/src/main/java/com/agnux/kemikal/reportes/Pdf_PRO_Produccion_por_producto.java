...
public class Pdf_PRO_Produccion_por_producto {
    public Pdf_PRO_Produccion_por_producto(HashMap<String, String> datosEncabezadoPie, String fileout, ArrayList<HashMap<String, String>> datos_produccion, HashMap<String, String> datos) throws DocumentException {
    try {
                    ...
                    Pdf_PRO_Produccion_por_producto.HeaderFooter event = new Pdf_PRO_Produccion_por_producto.HeaderFooter(datos);
                    ...
                    doc.open();
                    float [] widths = {1,1,1.5f,0.7f,3.5f,1};//Tamaño de las Columnas.
                    PdfPTable tabla = new PdfPTable(widths);
                    PdfPCell cell;
                    tabla.setKeepTogether(false);
                    tabla.setHeaderRows(1);
                        String titulos[ ] ={"Folio orden","Numero lote","Elaboracion","Codigo","Descripcion","Cantidad"};
