...
public class CxcIepsCobradoPorClientePdf {
    ...
    public CxcIepsCobradoPorClientePdf(HashMap<String,Object> data) {
        ...
        try {
            ...
            widths[0] = 3.5f;//cliente
            widths[1] = 0.3f;//moneda_simbolo_subtotal
            widths[2] = 2f;//subtotal
            widths[3] = 0.3f;//moneda_simbolo_retencion
            widths[4] = 2f;//retencion
            widths[5] = 0.3f;//moneda_simbolo_iva
            widths[6] = 2f;//iva
            int x=7;
