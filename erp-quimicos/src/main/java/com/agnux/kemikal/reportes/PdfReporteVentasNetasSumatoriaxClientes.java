...
public class PdfReporteVentasNetasSumatoriaxClientes {
    ...
    public PdfReporteVentasNetasSumatoriaxClientes(ArrayList<HashMap<String, String>> lista_ventas,String producto,String fecha_inicial,String fecha_final, String razon_social_empresa, String fileout) {
    this.setEmpresa_emisora(razon_social_empresa);
        ...
        try{
            ...
            String[] titulos = {"CLIENTE","UNIDAD","TOTAL CANTIDAD","","PRECIO PROMEDIO","","VENTA TOTAL"};
				...
				HashMap<String, String> registro= lista_ventas.get(j);
                                ...
                                if(cliente.equals(registro.get("razon_social"))){
                                    ...
                                    if(tmp != 0){
                                        if(nombre_cliente==1){
                                            if(producto !="" ){
                                                        cell = new PdfPCell(new Paragraph(producto.toString(),smallFontN));	
                                                        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                                                        cell.setColspan(9);
                                                        cell.setBorder(0);
                                                        tabla.addCell(cell); 
