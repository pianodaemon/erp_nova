...
/**
 *
 * @author junior colombiano
 */
public class PdfReporteComOrdenDeCompra {
    ...
    public PdfReporteComOrdenDeCompra(HashMap<String, String> datosEncabezadoPie, HashMap<String, String> datosOrdenCompra, ArrayList<HashMap<String, String>> conceptosOrdenCompra, String razon_social_empresa, String fileout, String ruta_imagen) throws DocumentException, FileNotFoundException {
        ...
        PdfReporteComOrdenDeCompra.ImagenPDF imagenpdf = new PdfReporteComOrdenDeCompra.ImagenPDF();
        ...
        try {            
            ...
            float [] tam_tablaHead = {3,3,9,5};
            PdfPTable tablaHead = new PdfPTable(tam_tablaHead);
            PdfPCell celdaHead;
            tablaHead.setKeepTogether(false);
            
            //nombre de Grupo
            celdaHead = new PdfPCell(new Paragraph("GRUPO",smallBoldFont));
            ...
            //CONTENIDO DE GRUPO 
            celdaHead = new PdfPCell(new Paragraph(datosOrdenCompra.get("grupo"),fuenteCont));
            celdaHead.setHorizontalAlignment(Element.ALIGN_CENTER);
            tablaHead.addCell(celdaHead);
            ...
            //2
            celdapie = new PdfPCell(new Paragraph("PERSONAL",fuentePie));
            celdapie.setHorizontalAlignment(Element.ALIGN_CENTER);
            celdapie.setBorder(0);tablapie.addCell(celdapie);
            //3
            celdapie = new PdfPCell(new Paragraph("CORREO",fuentePie));
            celdapie.setHorizontalAlignment(Element.ALIGN_CENTER);
            celdapie.setBorder(0);tablapie.addCell(celdapie);
            //4
            celdapie = new PdfPCell(new Paragraph("FAX       TELEX",fuentePie));
            celdapie.setHorizontalAlignment(Element.ALIGN_CENTER);
            celdapie.setBorder(0);tablapie.addCell(celdapie);
            //5
            celdapie = new PdfPCell(new Paragraph("NO DUPLICAR",fuentePie));
            celdapie.setHorizontalAlignment(Element.ALIGN_CENTER);
            celdapie.setBorder(0);tablapie.addCell(celdapie);
            //6
            ...
            celdapie.setHorizontalAlignment(Element.ALIGN_CENTER);
            tablapie.addCell(celdapie);//celdapie.setBorder(0);
            //2
            celdapie = new PdfPCell(new Paragraph("FECHA REQUERIDA\nREQUIRED DATE",fuentePie));
            celdapie.setHorizontalAlignment(Element.ALIGN_CENTER);
            tablapie.addCell(celdapie);//celdapie.setBorder(0);
            //3
            celdapie = new PdfPCell(new Paragraph("FECHA PROMETIDA\nPROMITED DATE",fuentePie));
            celdapie.setHorizontalAlignment(Element.ALIGN_CENTER);
            tablapie.addCell(celdapie);//celdapie.setBorder(0);
            //4
            celdapie = new PdfPCell(new Paragraph("OBSERVACIONES\nREMARKS",fuentePie));
            celdapie.setHorizontalAlignment(Element.ALIGN_CENTER);
            tablapie.addCell(celdapie);//celdapie.setBorder(0);
            //5
            celdapie = new PdfPCell(new Paragraph("CANTIDAD RECIBIDA",fuentePie));
            celdapie.setHorizontalAlignment(Element.ALIGN_CENTER);
            tablapie.addCell(celdapie);//celdapie.setBorder(0);
            //6
    ...
    private class TablaDetalleCompraPDF{
            public PdfPTable addContent(HashMap<String, String> datosOrdenCompra,ArrayList<HashMap<String, String>> conceptosOrdenCompra){
                ...
                float [] tam_tamBody = {2,2,3,1.8f,1.5f,1,2,1,0.7f,2};//Tamaño de las Columnas.
                PdfPTable tablaBody = new PdfPTable(tam_tamBody);
                PdfPCell celdaBody;
                tablaBody.setKeepTogether(false);
                
                //ESTOS SON LOS ENCABEZADOS DE LA ORDEN DE COMPRA DETALLE  MODIFIED
                celdaBody = new PdfPCell(new Paragraph("ARTICULO",smallBoldFont));
                celdaBody.setUseAscender(true);
                ...
                tablaBody.addCell(celdaBody);
                //4
                celdaBody = new PdfPCell(new Paragraph("RESOURCE",smallBoldFont));
                celdaBody.setUseAscender(true);
                celdaBody.setHorizontalAlignment(Element.ALIGN_CENTER);
                celdaBody.setUseDescender(true);
                celdaBody.setVerticalAlignment(Element.ALIGN_CENTER);
                ...
                celdaBody.setHorizontalAlignment(Element.ALIGN_CENTER);
                celdaBody.setUseDescender(true);
                celdaBody.setVerticalAlignment(Element.ALIGN_MIDDLE);
                celdaBody.setBackgroundColor(BaseColor.BLACK);
                tablaBody.addCell(celdaBody);
                //6
                ...
                tablaBody.addCell(celdaBody);
                //8
                celdaBody = new PdfPCell(new Paragraph("% \n D",smallBoldFont));
                celdaBody.setUseAscender(true);
                celdaBody.setHorizontalAlignment(Element.ALIGN_CENTER);
                celdaBody.setUseDescender(true);
                celdaBody.setVerticalAlignment(Element.ALIGN_CENTER);
