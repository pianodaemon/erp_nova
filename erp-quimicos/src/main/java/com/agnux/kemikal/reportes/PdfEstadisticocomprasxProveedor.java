...
public class PdfEstadisticocomprasxProveedor {
    ...
    public PdfEstadisticocomprasxProveedor(ArrayList<HashMap<String, String>> lista_ventas,String fecha_inicial,String fecha_final, String razon_social_empresa, String fileout) {
		this.setEmpresa_emisora(razon_social_empresa);
        //this.setEmpresa_emisora(razon_social_empresa);
        PdfEstadisticocomprasxProveedor.HeaderFooter event = new PdfEstadisticocomprasxProveedor.HeaderFooter();
        ...
        try{
			...
			//String registros=lista_ventas.get(0).get("razon_social").toString();
                        proveedor =lista_ventas.get(0).get("razon_social").toString();
                        unidad=lista_ventas.get(0).get("unidad").toString();

                        cell = new PdfPCell(new Paragraph("Proveedor: "+proveedor,smallFont));
                        cell.setColspan(13);
                        cell.setBorder(0);
                        tabla.addCell(cell);
			...
			for (int j=0; j<=lista_ventas.size()-1; j++){     //inicia for para recorrer las filas de la lista
				...
				HashMap<String, String> registro= lista_ventas.get(j);
                                ...
                                if(proveedor.equals(registro.get("razon_social")) && unidad.equals(registro.get("unidad")) ){   //compara si todos los registros de la razon social
    ...
    class HeaderFooter extends PdfPageEventHelper  {
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            ...
            ColumnText.showTextAligned(writer.getDirectContent(),Element.ALIGN_CENTER, new Phrase(PdfEstadisticocomprasxProveedor.this.getEmpresa_emisora(),largeBoldFont),document.getPageSize().getWidth()/2, document.getPageSize().getTop() -25, 0);
            ColumnText.showTextAligned(writer.getDirectContent(),Element.ALIGN_CENTER, new Phrase("Reporte Estadistico de Compras por proveedor.",largeBoldFont),document.getPageSize().getWidth()/2, document.getPageSize().getTop()-38, 0);
