...
public class PdfReporteVentasNetasSumatoriaxProducto {
    ...
    public PdfReporteVentasNetasSumatoriaxProducto(ArrayList<HashMap<String, String>> lista_ventas,String cliente,String fecha_inicial,String fecha_final, String razon_social_empresa, String fileout) {
    this.setEmpresa_emisora(razon_social_empresa);
        //this.setEmpresa_emisora(razon_social_empresa);
        PdfReporteVentasNetasSumatoriaxProducto.HeaderFooter event = new PdfReporteVentasNetasSumatoriaxProducto.HeaderFooter();
				...
				HashMap<String, String> registro= lista_ventas.get(j);
                                ...
                                if(producto.equals(registro.get("producto"))){
                                    ...
                                    if(tmp != 0){
                                        if(nombre_cliente==1){
                                            if(producto !="" ){
                                                        cell = new PdfPCell(new Paragraph(cliente.toString(),smallFontN));	
                                                        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                                                        cell.setColspan(9);
                                                        cell.setBorder(0);
                                                        tabla.addCell(cell); 
