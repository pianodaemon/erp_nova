 ...
 * @author agnux
 */
public class CtbPdfReportePolizasContables {
    ...
    public CtbPdfReportePolizasContables(String fileout, HashMap<String, String> datosEncabezadoPie, HashMap<String, String> datosEmpresa, ArrayList<HashMap<String, String>> itemsForPrinting){
    ...
    private void init(){
        ...
        Font smallFontBlack = new Font(Font.getFamily("ARIAL"),9,Font.NORMAL,BaseColor.BLACK);
         //{2.5f, 6f, 1.5f,1.5f, 1.5f, 1.5f};
        float [] ancho_columnas = {2.5f, 6f, 3.5f,1.5f, 1.5f};
        ...
        try {
            ...
            //String[] columnasHeader = {"Cuenta","Descripcion"};
            String[] columnasHeader = {"Cuenta","Descripcion","Observación","Debe","Haber"};
            ...
            for ( String columna_titulo : lista_columnas_header){
                ...
                if (columna_titulo.equals("Observación")){
                    cellX.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellX.setVerticalAlignment(Element.ALIGN_MIDDLE);   
                }
            ...
            for (HashMap<String, String> i : this.getRows()){
                ...
                //String[] wordList = {"cuenta","descripcion",};
                String[] wordList = {"cuenta","descripcion","descripcion","debe","haber"};
            ...
            Logger.getLogger(CtbPdfReportePolizasContables.class.getName()).log(Level.SEVERE, null, ex);
        }    
    }
