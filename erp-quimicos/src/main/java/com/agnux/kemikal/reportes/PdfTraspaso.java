...
public final class PdfTraspaso {
    ...
    public PdfTraspaso(HashMap<String, String> datos_empresa, HashMap<String, String> datos_traspaso, ArrayList<HashMap<String, String>> lista_productos, String fileout, String ruta_imagen) {
        ...
        this.setTipo_documento("TRASPASO");
        this.setFolio_traspaso(datos_traspaso.get("folio_traspaso"));
        this.setFecha_traspaso(datos_traspaso.get("fecha_traspaso"));
    ...
    private class CeldaPDF {
        public PdfPTable addContent() {
            ...
            cell = new PdfPCell(new Paragraph("FOLIO TRASPASO",smallBoldFont));
            cell.setUseAscender(true);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setUseDescender(true);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            ...
            cell = new PdfPCell(new Paragraph("FECHA TRASPASO",smallBoldFont));
            cell.setUseAscender(true);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setUseDescender(true);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
    ...
    private class TablaPDF {
        public PdfPTable addContent() {
           ...
           while(it.hasNext()){
                ...
                //cantidad del ajuste
                cell = new PdfPCell(new Paragraph(StringHelper.AgregaComas(map.get("cant_traspaso")), smallFont));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
