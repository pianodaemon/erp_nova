...
public class PdfReporteVentasNetasProductoFacturados {
    ...
    public PdfReporteVentasNetasProductoFacturados(ArrayList<HashMap<String, String>> lista_ventas,String fecha_inicial,String fecha_final, String razon_social_empresa, String fileout) {
		this.setEmpresa_emisora(razon_social_empresa);
        //this.setEmpresa_emisora(razon_social_empresa);
        PdfReporteVentasNetasProductoFacturados.HeaderFooter event = new PdfReporteVentasNetasProductoFacturados.HeaderFooter();
        ...
        try{
            ...
            */
            float [] widths = {2.2f,10f,3f,3f,2f,2f,1f,3f,1f,3f,2f,1f,3f};
            ...
            String[] titulos = {"N.C0NTROL","CLIENTE","FACTURA","FECHA","UNIDAD","CANTIDAD","","PRECIO UNITARIO","","VENTA NETA","MONEDA","","TIPO CAMBIO"};
			...
			for (int j=0; j<=lista_ventas.size()-1; j++){     //inicia for para recorrer las filas de la lista    
				...
				HashMap<String, String> registro= lista_ventas.get(j);
					...
					//pÅ•oducto mostrando su total de la venta Neta.
			...
			cell.setBorder(0);
			tabla.addCell(cell);
			//fin total venta del ultimo prodcuto que se muestra en el pdf
