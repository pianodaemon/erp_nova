 ...
 * @author Ezequiel
 */
public class PdfProOrdenRequisicion {
    
    public PdfProOrdenRequisicion(HashMap<String, String> datosEncabezadoPie,String fileout,ArrayList<HashMap<String, Object>> lista,HashMap<String, String> datos) throws FileNotFoundException, DocumentException {
        ...
        try {
            ...
            for (int j=0;j<lista.size();j++){
                ...
                float [] form_tabla = {2.8f,3f,3f,3f,3f};
                        ...
                        tablaXX.setKeepTogether(false);
                         ...
                         for (int l=0;l<listaesp.size();l++){
                             ...
                             if(!id_esp.equals(registrotmp.get("id"))){
                                ...
                                //colspan 5 fil1
                                celdaXX = new PdfPCell(new Paragraph("ESPECIFICACIONES DE PRODUCCION",fuentenegrita));
                                celdaXX.setHorizontalAlignment(Element.ALIGN_LEFT);
                                celdaXX.setVerticalAlignment(Element.ALIGN_MIDDLE);
                                celdaXX.setBorderWidthBottom(0);
                                celdaXX.setColspan(4);
...
/*
            ...
            float [] tam_tablay = {4f,2f,2f,2f,4f};
