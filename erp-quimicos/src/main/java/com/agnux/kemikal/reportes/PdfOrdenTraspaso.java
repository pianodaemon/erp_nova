 ...
 * 
 */
public final class PdfOrdenTraspaso {
    ...
    private ArrayList<HashMap<String, String>> lista_lotes = new ArrayList<HashMap<String, String>>();
    ...
    private String folio_traspaso;
    private String fecha_traspaso;
    ...
    public String getFecha_traspaso() {
        return fecha_traspaso;
    }

    public void setFecha_traspaso(String fecha_traspaso) {
    ...
    public String getFolio_traspaso() {
        return folio_traspaso;
    }

    public void setFolio_traspaso(String folio_traspaso) {
        this.folio_traspaso = folio_traspaso;
    }
    ...
    public ArrayList<HashMap<String, String>> getLista_lotes() {
        return lista_lotes;
    }

    public void setLista_lotes(ArrayList<HashMap<String, String>> lista_lotes) {
        this.lista_lotes = lista_lotes;
    }
    ...
    public PdfOrdenTraspaso(HashMap<String, String> datos_empresa, HashMap<String, String> datos_traspaso, ArrayList<HashMap<String, String>> lista_productos, ArrayList<HashMap<String, String>> lista_lotes,String fileout, String ruta_imagen) {
        ...
        this.setTipo_documento("ORDEN DE TRASPASO");
        this.setFolio_traspaso(datos_traspaso.get("folio"));
        this.setFecha_traspaso(datos_traspaso.get("fecha"));
        this.setAlmacenOrigen(datos_traspaso.get("alm_origen"));
        this.setAlmacenDestino(datos_traspaso.get("alm_destino"));
        this.setObservaciones(datos_traspaso.get("observaciones"));
        this.setUsuario_elaboracion(datos_traspaso.get("nombre_usuario"));
        this.setLista_productos(lista_productos);
        this.setLista_lotes(lista_lotes);
        ...
        datos.put("codigo1", datos_traspaso.get("codigo1"));
        datos.put("codigo2", datos_traspaso.get("codigo2"));
    ...
    private class CeldaPDF {
        public PdfPTable addContent() {
            ...
            cell = new PdfPCell(new Paragraph(getFolio_traspaso(),sont));
            cell.setUseAscender(true);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setUseDescender(true);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            ...
            cell = new PdfPCell(new Paragraph(getFecha_traspaso(),smallFont));
            cell.setUseAscender(true);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setUseDescender(true);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
    ...
    private class TablaPDF {
        public PdfPTable addContent() {
            ...
            Font smallFont = new Font(Font.FontFamily.HELVETICA,7,Font.NORMAL,BaseColor.BLACK);
            Font smallFont2 = new Font(Font.FontFamily.HELVETICA,7,Font.ITALIC,BaseColor.BLACK);
            Font smallBoldFont = new Font(Font.FontFamily.HELVETICA, 8, Font.BOLD, BaseColor.WHITE);
            HashMap<String,String> mapPartida=null;
            HashMap<String,String> mapLote=null;
            ...
            cell = new PdfPCell(new Paragraph("Cant. Traspaso",smallBoldFont));
            cell.setUseAscender(true);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setUseDescender(true);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            ...
            while(it.hasNext()){
                mapPartida = (HashMap<String,String>)it.next();
                
                cell = new PdfPCell(new Paragraph(esteAtributoSeDejoNulo(mapPartida.get("codigo")), smallFont));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                ...
                //cantidad del ajuste
                cell = new PdfPCell(new Paragraph(StringHelper.AgregaComas(mapPartida.get("cant_traspaso")), smallFont));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                ...
                it2 = getLista_lotes().iterator();
                while(it2.hasNext()){
                    mapLote = (HashMap<String,String>)it2.next();
                    if( mapLote.get("id_partida").equals(mapPartida.get("id_partida"))){
                        cell = new PdfPCell(new Paragraph("", smallFont2));
                        cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                        cell.setBorderWidthBottom(0);
                        cell.setBorderWidthTop(0);
                        ...
                        //cantidad del ajuste
                        cell = new PdfPCell(new Paragraph(StringHelper.AgregaComas(mapLote.get("cant_traspaso")), smallFont));
                        cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
                        cell.setBorderWidthBottom(0);
                        cell.setBorderWidthTop(0);
