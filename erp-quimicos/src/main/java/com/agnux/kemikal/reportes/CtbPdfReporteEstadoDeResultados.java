...
public class CtbPdfReporteEstadoDeResultados {
    ...
    public CtbPdfReporteEstadoDeResultados(String fileout, HashMap<String, String> datosEncabezadoPie, HashMap<String, String> datosEmpresa, ArrayList<HashMap<String, String>> itemsForPrinting){
    ...
    private void init(){
        ...
        float [] ancho_columnas = {6f,2f,1.5f,2f,1.5f};
        ...
        try {
            ...
            String[] columnasHeader = {"Descripción","Saldo Mensual","%","Saldo Anual","%"};
            ...
            for ( String columna_titulo : lista_columnas_header){
                ...
                if (columna_titulo.equals("Saldo Mensual")){
                    cellX.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellX.setVerticalAlignment(Element.ALIGN_MIDDLE);   
                }
                ...
                if (columna_titulo.equals("Saldo Anual")){
                    cellX.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellX.setVerticalAlignment(Element.ALIGN_MIDDLE);   
                }
            ...
            for (HashMap<String, String> i : this.getRows()){
                ...
                String[] wordList = {"descripcion","saldo_inicial","saldo_inicial","saldo_final","saldo_final"};
            ...
            Logger.getLogger(CtbPdfReporteEstadoDeResultados.class.getName()).log(Level.SEVERE, null, ex);
        }    
    }
