...
//   public PdfReporteCobrazaAgente(String fileout, ArrayList<HashMap<String, String>> lista_cobranza, String razon_social_empresa, String fecha_inicial, String fecha_final) throws DocumentException {
    public PdfReporteCobrazaAgente(String fileout, ArrayList<HashMap<String, String>> cobranza_venta, Integer opcion_seleccionada, String razon_social_empresa, String fecha_inicial, String fecha_final)throws DocumentException {
    ...
    try {
		...
		doc.open();
          ...
          if(tipo_rep==1){
                    ...
                    /*
                    cell = new PdfPCell(new Paragraph("NOMBRE",smallBoldFont));
                    ...
                    for (int x=0; x<=(cobranza_venta.size())-1; x++){
                         ...
                         if(nombre_agente.equals(registro.get("nombre_agente")) &&  denominacion.equals(registro.get("moneda_factura"))){
                              if(tmp==0){
                                   ...
                                   cell= new PdfPCell(new Paragraph(StringHelper.AgregaComas(StringHelper.roundDouble(registro.get("comision"),2)+"%"),smallFont));
                                   cell.setHorizontalAlignment (Element.ALIGN_CENTER);
                                   cell.setBorder(0);
                                   tabla.addCell(cell);
                                   ...
                                   cell= new PdfPCell(new Paragraph(StringHelper.AgregaComas(StringHelper.roundDouble(registro.get("total_comision"),2)),smallFont));
                                   cell.setHorizontalAlignment (Element.ALIGN_RIGHT);
                                   cell.setBorder(0);
                                   tabla.addCell(cell);
                              }
                              ...
                              sumatotalcomision = sumatotalcomision  + Double.parseDouble(registro.get("total_comision").toString());
                              tmp = 1;
               ...
               */
               ...
               tabla.addCell(cell);
                /*
                //fila DE LA LEYENDA AL FINAL
                cell= new PdfPCell(new Paragraph("EL VALOR A CONSIDERAR ES SIN IVA",smallFontN));
                cell.setHorizontalAlignment (Element.ALIGN_LEFT);
                cell.setBorder(0);
                cell.setColspan(9);
                tabla.addCell(cell);
