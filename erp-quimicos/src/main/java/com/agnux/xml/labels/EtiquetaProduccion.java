 ...
 * @author mi_compu
 */
public final class EtiquetaProduccion extends AgnuxXmlObject{
    public EtiquetaProduccion(LinkedHashMap<String, Object> datos_cuerpo){
        super();
    ...
    private void construyeNodoEtiqueta(){
        ...
        Element element = tmp.createElement("etiquetaproduccion");
