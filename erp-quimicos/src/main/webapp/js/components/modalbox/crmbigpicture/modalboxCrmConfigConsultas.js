(function($){
	$.fn.extend({
		modalPanelCrmConfigConsultas: function() {
			...
			var overlay = $("<div id='forma-crmconfigconsultas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-crmconfigconsultas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-crmconfigconsultas-overlay").append(modalWindow);
