	...
	$.fn.extend({
		modalPanel_invactualizaprecios: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-invactualizaprecios-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-invactualizaprecios-window'></div>");
			...
			//return this.each(function() {
				...
				//$(this).click(function(e) {
					...
					$("#forma-invactualizaprecios-overlay").append(modalWindow);
