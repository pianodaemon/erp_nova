	...
	var carga_formainvordendev00_for_datagrid00 = function(id_to_show, accion_mode){
		...
		if(accion_mode == 'cancel'){
			...
			if(accion_mode == 'edit'){
				...
				var $folio_salida = $('#forma-invordendev-window').find('input[name=folio_salida]');
				var $estatus = $('#forma-invordendev-window').find('input[name=estatus]');
				var $accion = $('#forma-invordendev-window').find('input[name=accion]');
				var $select_tipo_movimiento = $('#forma-invordendev-window').find('select[name=select_tipo_movimiento]');
				...
				var $select_tipo_doc = $('#forma-invordendev-window').find('select[name=select_tipodoc]');
				...
				var $orden_compra = $('#forma-invordendev-window').find('input[name=orden_compra]');
				var $folio_pedido = $('#forma-invordendev-window').find('input[name=folio_pedido]');
				var $campo_tc = $('#forma-invordendev-window').find('input[name=tc]');
				var $observaciones = $('#forma-invordendev-window').find('textarea[name=observaciones]');
				var $select_almacen_origen = $('#forma-invordendev-window').find('select[name=select_almacen_origen]');
				...
				//campos de totales
				var $campo_subtotal = $('#forma-invordendev-window').find('input[name=subtotal]');
				var $campo_retencion = $('#forma-invordendev-window').find('input[name=retencion]');
				var $campo_impuesto = $('#forma-invordendev-window').find('input[name=totimpuesto]');
				var $campo_total = $('#forma-invordendev-window').find('input[name=total]');
				
				var $confirmar = $('#forma-invordendev-window').find('#confirmar');
