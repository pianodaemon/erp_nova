...
//		alert("tipo_reporte"+tipo_reporte+"id_proveedor"+id_proveedor+"fecha_corte"+fecha+"iu"+iu);
//		var input_json = config.getUrlForGetAndPost() + '/get_genera_pdf_estado_cuenta_prov/'+tipo_reporte+'/'+id_proveedor+'/'+fecha+'/'+iu+'/out.json'
...
//	});//termina llamada json
	...
	$genera_PDF.click(function(event){
		...
		var iu = $('#lienzo_recalculable').find('input[name=iu]').val();
		var input_json = config.getUrlForGetAndPost() + '/get_genera_pdf_estado_cuenta_proveedor/'+$select_tipo_reporte.val()+'/'+id_proveedor+'/'+fecha+'/'+iu+'/out.json'
		window.location.href=input_json;
	...
	$busqueda_reporte_edocta.click(function(event){
		...
		$div_reporte_estados_de_cuenta.children().remove();
			...
			var arreglo_parametros = {	tipo_reporte: $select_tipo_reporte.val(),
										id_proveedor: $id_proveedor_edo_cta.val(),
