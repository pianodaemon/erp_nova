$(function() {
          var config =  {
			...
			var $Buscar_numero_de_kits= $('#lienzo_recalculable').find('div.articulosreservados').find('table#filtros tr td').find('input[value$=Buscar]');
			...
			//click generar reporte de pronostico de Cobranza
               $genera_reporte_articulos_resevados.click(function(event){
                    ...
                    var input_json = config.getUrlForGetAndPost()+'/getallArticulosReservados/'+config.getUi()+'/out.json';
                              ...
                              for(var i=0; i<body_tabla.length; i++){
                                   if(Producto != body_tabla[i]["sku"] ){
                                         if (tmp == 0){
                                             ...
                                             html_articulosreservados +='<td align="left" colspan ="7">'+body_tabla[i]["descripcion"]+'</td>'; 
                                             html_articulosreservados +='</tr>'; 
