$(function() {
	...
	$genera_pdf_reporte.click(function(event){
		event.preventDefault();
		var cadena = $id_cliente.val()+"___"+$select_tipo_reporte.val()+"___"+$fecha_corte.val();
...
*/	
			...
			for(var key in header_tabla){
				...
				if(attrValue == 'Factura'){
					html_reporte +='<td  align="left">'+attrValue+'</td>'; 
				}
				
				if(attrValue == 'Fecha Factura'){
					html_reporte +='<td  align="center">'+attrValue+'</td>'; 
				}
