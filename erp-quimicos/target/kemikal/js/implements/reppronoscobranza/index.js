$(function() {
    ...
    $select_cobranza.change(function(event){
        ...
        var arreglo_parametros = {opcion_seleccionada : $select_cobranza.val() , numero_semanas : $select_semanas.val(), iu:config.getUi()};
                ...
                if(parseInt(numero_semanas) == 1){ 
                    ...
                    $.post(restful_json_service,arreglo_parametros,function(entry){
                        ...
                        var header_tabla = {    semana_1    :" ",
                                    ...
                                    var html_pronostico_semanas = '<table id="pronosticos_semanas" width="100%" border="2" bordercolor="red">';
                                    ...
                                    html_pronostico_semanas +='<td >'+""+'</td>'; 
                                    html_pronostico_semanas +='<td align="center">'+primer_semana_lunes+'________Al________'+primer_semana_viernes+'</td>'; 
                ...
                if(numero_semanas == 2){ 
                        ...
                        var restful_json_service = config.getUrlForGetAndPost() + '/getPronosticoDeCobranza.json'
                            ...
                            $.post(restful_json_service,arreglo_parametros,function(entry){
                                    ...
                                    html_pronostico_semanas +='<td >'+""+'</td>'; 
                                    html_pronostico_semanas +='<td align="center">'+primer_semana_lunes+'________Al________'+primer_semana_viernes+'</td>'; 
                                    html_pronostico_semanas +='<td align="center">'+segunda_semana_lunes+'________Al________'+segunda_semana_viernes+'</td>'; 
                                    html_pronostico_semanas +='<td align="center">'+""+'</td>'; 
                                    html_pronostico_semanas +='<td align="center">'+""+'</td>'; 
                                    html_pronostico_semanas +='<td align="center">'+""+'</td>'; 
                                    html_pronostico_semanas +='<tr>';
                        ...
                        var restful_json_service = config.getUrlForGetAndPost() + '/getPronosticoDeCobranza.json'
                            ...
                            $.post(restful_json_service,arreglo_parametros,function(entry){
                                   ...
                                   total_primer_semana=parseFloat(total_primer_semana);
                                    ...
                                    html_pronostico_semanas +='<td align="center">'+primer_semana_lunes+'________Al________'+primer_semana_viernes+'</td>'; 
                                    html_pronostico_semanas +='<td align="center">'+segunda_semana_lunes+'________Al________'+segunda_semana_viernes+'</td>'; 
                                    html_pronostico_semanas +='<td align="center">'+tercer_semana_lunes+'________Al________'+tercer_semana_viernes+'</td>'; 
                                    html_pronostico_semanas +='<td align="center">'+""+'</td>'; 
                                    html_pronostico_semanas +='<td align="center">'+""+'</td>'; 
                                    html_pronostico_semanas +='<tr>';
                        ...
                        var restful_json_service = config.getUrlForGetAndPost() + '/getPronosticoDeCobranza.json'
                            ...
                            $.post(restful_json_service,arreglo_parametros,function(entry){
                                   ...
                                   total_primer_semana=parseFloat(total_primer_semana);
                                    ...
                                    html_pronostico_semanas +='<td align="center">'+segunda_semana_lunes+'________Al________'+segunda_semana_viernes+'</td>'; 
                                    html_pronostico_semanas +='<td align="center">'+tercer_semana_lunes+'________Al________'+tercer_semana_viernes+'</td>'; 
                                    html_pronostico_semanas +='<td align="center">'+cuarta_semana_lunes+'________Al________'+cuarta_semana_viernes+'</td>'; 
                                    html_pronostico_semanas +='<td align="center">'+""+'</td>'; 
                                    html_pronostico_semanas +='<tr>';
        ...
        if(opcion_seleccionada==2 && numero_semanas != 0){
            ...
            $.post(restful_json_service,arreglo_parametros,function(entry){
                ...
                var html_fechas = '<table id="fechas" width="100%",  border= 0, bordercolor="red">';
                    var salto=0;
                    for(var i=0; i<body_tabla.length; i++){       
                            if(salto == 0){
                ...
                var html_pronostico_semana = '<table id="pronosticos_semana", width="100%", border= 2, bordercolor="red">';
                ...
                for(var j=0; i<body_tabla.length; j++){
                    var cliente= body_tabla[j]["cliente"];
        ...
        if(opcion_seleccionada==3 && numero_semanas != 0){
            ...
            $.post(restful_json_service,arreglo_parametros,function(entry){
                    ...
                    var html_pronostico = '<table id="pronosticos" width="100%",  border= 0, bordercolor="red">';
                        ...
                        if(body_tabla[i]["cliente"]==cliente){
                            if(tmp==0){
                                ...
                                html_pronostico +='</tr>';
                                    ...
                                    html_pronostico +='<tr>';
                                    html_pronostico +='<td  >'+body_tabla[i]["cliente"]+'</td>'; 
